const mockQuest = {
    ...
    stages: [
        ...
        },
        {
            ...
            type: "text",
            text: `Для начала тебе нужно одеться (напоминаю, потеплее, как ты любишь) и двинуться к точке на карте следующего этапа. Геолокация работает плохо, поэтому рядом с каждым ключевым местом будут стрелочки, смотри под ноги. Если что пиши`
        },
        {
            order: 4,
            title: "Красивое?",
        ...
        },
        {
            ...
            type: "text",
            text: `Двигайся к точке (по стрелочкам, за будку) и собери 4 <b>QR-кода</b>, главное <b>сохрани их</b>, они пригодятся тебе в будушем, <b> порядок сканирования тоже является ключом</b>. Коды на деревьях. Если кодов нет или их спиздили, или дальше, просто пропусти этапы с кодами (стрелочка на права, сверху). `
        },
        {
            order: 6,
            title: "Первый код",
        ...
        {
            order: 14,
            title: "Найди велик по карте, он приделан к столбу (на нем коды, если те спиздили) ",
            type: "map",
            point: {
                latitude: 55.655285,
                longitude: 37.522820
